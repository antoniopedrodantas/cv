      ...
      <div className="content-left">
        ...
        <div className="card-info">
          <p>
            ...
            be pointless to show them all here, so I'll just list the ones I am
            more proud of and think are the most useful.
          </p>
          <div className="wrapper-project">
            ...
            <div className="div2">
              ...
              <p>
                ...
                <mark>simulating a skyscraper</mark> environment that contained
                lifts. The idea was to be able to introduce certain independent
                variables (ex: number of floors, number of lifts, each lift's
                max weight) and analyzing data to understand what would be the
                most efficient building configuration. This project was
                developed in <mark>Java</mark> using Jade and Repast libraries.
              </p>
              <br></br>
              <img
                className="project-image"
            ...
            <div className="div3">
              ...
              <p>
                ...
                <mark>Information Systems</mark> course. The goal of the project
                was to develop a web application for the{" "}
            ...
            <div className="div4">
              ...
              <p>
                ...
                develop an agent that could <mark>beat a puzzle game</mark>. We
                chose to recreate Box World. The rules are simple, the red
                square needs to get to the blue square. In order to do so it
                will have to solve the level's layout by pushing some boxes and
                ice cubes. This project was made using <mark>Pyhton</mark>.
              </p>
              <br></br>
              <img
                className="project-image"
